...
# py_files = glob.glob(r'*.py', recursive=True)
# py_files.remove('setup.py')
# py_files.remove('apprcc_rc.py')
# setup(name='myapp', ext_modules=cythonize(py_files))
setup(name='myapp', ext_modules=cythonize(['file.py', 'tab_horizontal_west.py']))